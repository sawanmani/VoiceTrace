  ...
  return (
    <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 4, height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', padding: '12px', borderBottom: '1px solid var(--border)' }}>
        <div>
          <h3 style={{ margin: 0, fontSize: 17, fontWeight: 800, letterSpacing: 0.5, textTransform: 'uppercase' }}>INCIDENT REPORT & ALERTS</h3>
          <div style={{ fontSize: 15, color: 'var(--text-secondary)', marginTop: 2 }}>Always active</div>
        </div>
      ...
      <div style={{ padding: '16px', flex: 1, display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div style={{ background: 'var(--bg-base)', border: '1px solid var(--border)', borderRadius: 4, padding: 12, position: 'relative' }}>
          ...
          <div style={{ fontSize: 17, fontWeight: 800, marginBottom: 8, letterSpacing: 0.5 }}>ALERT: CLONE SIGNATURE DETECTED.</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginTop: 'auto' }}>
          <button style={{ width: '100%', padding: '8px', background: 'var(--bg-base)', border: '1px solid var(--border)', borderRadius: 4, fontSize: 16, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, cursor: 'pointer' }}>
